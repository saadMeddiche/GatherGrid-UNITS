...
public class EventServiceImpTest {
        ...
        public static Stream<Arguments> events() {
                ...
                User user = new User();
                return Stream.of(
                                Arguments.of(1L, "Event Title", "Event Description", "Event Location",
                                                "2023-10-26T08:00", 50, 30, 20,
                                                1L, 1L, new Response("Event Updated", 200), new Categorie(), user,
                                                Mockito.mock(Event.class),
                                                user),
                                Arguments.of(2L, "Invalid User", "Description", "Location", "2023-10-26T10:00", 50, 30,
                                                20, 1L, 999L,
                                                new Response("User Not Found", 404), new Categorie(), null,
                                                Mockito.mock(Event.class),
                                                user),
                                Arguments.of(3L, "Valid User", "Description", "Location", "2023-10-26T12:00", 50, 30,
                                                20, 999L, 1L,
                                                new Response("Category Not Found", 404), null, user,
                                                Mockito.mock(Event.class), user),
                                Arguments.of(4L, "Valid Usser", "Description", "Location", "2023-10-26T14:00", 50, 30,
                                                20, 1L, 1L,
                                                new Response("Event Not Found", 404), new Categorie(), user, null,
                                                user),
                                Arguments.of(5L, "Valid User", "Description", "Location", "2023-10-26T16:00", 50, 30,
                                                20, 1L, 2L,
                                                new Response("You are not allowed to update this event", 403),
                                                new Categorie(), user,
                                                Mockito.mock(Event.class), new User()));
        }
        ...
        public void updateEvent_whenSomeAttributesAreNull_thenShouldNotThrowNullExceptionWhen(Long id, String title,
                        String description,
                        String location, String dateTime, int vip_price, int regular_price, int basic_price,
                        Long category,
